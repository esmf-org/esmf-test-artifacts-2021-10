build time -- 2021-05-21 02:33:41
...
ESMF_APPSDIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/apps/appsg/Linux.gfortran.64.openmpi.default
ESMF_LIBSDIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
...
ESMF_F90LINKPATHS=-L/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -L/apps/gcc-8/netcdf-4.7.2/lib -L/apps/gcc-8/netcdf-4.7.2/lib -L/apps/gcc-8/hdf5-1.10.5/lib -L/apps/gcc-8/netcdf-4.7.2/lib -L/usr/lib64 -L/apps/gcc-8/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/apps/gcc-8/hdf5-1.10.5/lib -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/usr/lib64 -Wl,-rpath,/apps/gcc-8/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/src/include  -I/apps/gcc-8/netcdf-4.7.2/include -I/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_08-26-gb4c535d' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -L/apps/gcc-8/netcdf-4.7.2/lib -L/apps/gcc-8/netcdf-4.7.2/lib -L/apps/gcc-8/hdf5-1.10.5/lib -L/apps/gcc-8/netcdf-4.7.2/lib -L/usr/lib64 -L/apps/gcc-8/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/apps/gcc-8/hdf5-1.10.5/lib -Wl,-rpath,/apps/gcc-8/netcdf-4.7.2/lib -Wl,-rpath,/usr/lib64 -Wl,-rpath,/apps/gcc-8/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default
ESMF_CXXLINKLIBS= -lmpi_mpifh -lrt -lgfortran -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi_mpifh -lrt -lgfortran -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
...
ESMF_TRACE_LDPRELOAD=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop/lib/libg/Linux.gfortran.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
