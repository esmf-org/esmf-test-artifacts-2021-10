Mon Sep 20 10:22:51 CDT 2021
#!/bin/sh -l
#SBATCH --account=da-cpu
#SBATCH -o test-intel_2020_intelmpi_O.bat_%j.o
#SBATCH -e test-intel_2020_intelmpi_O.bat_%j.e
#SBATCH --time=2:00:00
...
ssh Orion-login-1.HPC.MsState.Edu /work/noaa/da/mpotts/sandbox//work/noaa/da/mpotts/sandbox/intel_2020_intelmpi_O_develop/getres-int.sh
