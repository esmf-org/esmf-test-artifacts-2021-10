...
ssh chianti /home/mpotts//home/mpotts/gfortran_9.3.0_openmpi_g_develop/getres-int.sh
...
ssh chianti /home/mpotts/gfortran_9.3.0_openmpi_g_develop/runpython.sh 2>&1 | tee python_build.log
