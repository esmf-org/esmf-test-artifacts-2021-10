build time -- 2021-05-06 03:13:29
...
ESMF_APPSDIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/apps/appsg/Unicos.gfortran.64.mpi.default
ESMF_LIBSDIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/mod/modg/Unicos.gfortran.64.mpi.default -I/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/src/include -I/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/include -I/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_06-2-g7cd9acbf16' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop
...
ESMF_F90LINKPATHS=-L/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/hdf5/1.10.4-gcc-7.3.0/lib -L/p/app/unsupported/hdf4/4.2.14-nonetcdf-gcc-7.3.0/lib -L/p/app/unsupported/szip/2.1.1-gcc-7.3.0/lib -L/opt/gcc/7.2.0/snos/lib/gcc/x86_64-suse-linux/7.2.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/hdf5/1.10.4-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/hdf4/4.2.14-nonetcdf-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/szip/2.1.1-gcc-7.3.0/lib -Wl,-rpath,/opt/gcc/7.2.0/snos/lib/gcc/x86_64-suse-linux/7.2.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/src/include  -I/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/include -I/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_06-2-g7cd9acbf16' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread  -fopenmp
ESMF_CXXLINKPATHS=-L/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -L/p/app/unsupported/hdf5/1.10.4-gcc-7.3.0/lib -L/p/app/unsupported/hdf4/4.2.14-nonetcdf-gcc-7.3.0/lib -L/p/app/unsupported/szip/2.1.1-gcc-7.3.0/lib -L/opt/gcc/7.2.0/snos/lib/gcc/x86_64-suse-linux/7.2.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.6.2-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/hdf5/1.10.4-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/hdf4/4.2.14-nonetcdf-gcc-7.3.0/lib -Wl,-rpath,/p/app/unsupported/szip/2.1.1-gcc-7.3.0/lib -Wl,-rpath,/opt/gcc/7.2.0/snos/lib/gcc/x86_64-suse-linux/7.2.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop/lib/libg/Unicos.gfortran.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /p/work/mpotts/gfortran_7.2.0_mpi_g_develop
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
