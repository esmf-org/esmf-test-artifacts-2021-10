#!/bin/sh -l
#PBS -N build-gfortran_7.2.0_mpi_g.bat
...
cd /p/work/mpotts/gfortran_7.2.0_mpi_g_develop
...
export ESMF_DIR=/p/work/mpotts/gfortran_7.2.0_mpi_g_develop
...
ssh onyx /p/work/mpotts/gfortran_7.2.0_mpi_g_develop/getres-build.sh
