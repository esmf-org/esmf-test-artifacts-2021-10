build time -- 2021-04-29 03:12:00
...
ESMF_APPSDIR=/p/work/mpotts/intel_2017.5_mpi_O_develop/apps/appsO/Unicos.intel.64.mpi.default
ESMF_LIBSDIR=/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/p/work/mpotts/intel_2017.5_mpi_O_develop/mod/modO/Unicos.intel.64.mpi.default -I/p/work/mpotts/intel_2017.5_mpi_O_develop/src/include -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/intel_2017.5_mpi_O_develop
...
ESMF_F90LINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -L/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -L/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -L/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64 
ESMF_F90ESMFLINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -Wl,-rpath,/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/p/work/mpotts/intel_2017.5_mpi_O_develop/src/include  -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include -I/p/work/mpotts/intel_2017.5_mpi_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_05-6-gb8c1a7077f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/intel_2017.5_mpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -L/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -L/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -L/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64 -L/opt/intel/compilers_and_libraries_2017.5.239/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -Wl,-rpath,/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKLIBS=  -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
ESMF_CXXESMFLINKLIBS=-lesmf   -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
...
ESMF_TRACE_LDPRELOAD=/p/work/mpotts/intel_2017.5_mpi_O_develop/lib/libO/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/p/work/mpotts/intel_2017.5_mpi_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /p/work/mpotts/intel_2017.5_mpi_O_develop
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
...
# ESMF_NETCDF_INCLUDE:    /p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include
# ESMF_NETCDF_LIBS:       -lnetcdf
# ESMF_NETCDF_LIBPATH:    /p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib
# ESMF_NFCONFIG:          nf-config
# ESMF_NETCDFF_INCLUDE:   /p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include
# ESMF_NETCDFF_LIBS:      -lnetcdff -lnetcdf -lnetcdf
# ESMF_NETCDFF_LIBPATH:   /p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib /p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib /p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib /p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib /p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib /opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64
# ESMF_PIO:               internal
