...
export ESMF_NETCDF=nc-config
export ESMF_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_mpiuni_g_develop
...
ssh hfe10 /scratch1/NCEPDEV/stmp2/Mark.Potts//scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_mpiuni_g_develop/getres-int.sh
