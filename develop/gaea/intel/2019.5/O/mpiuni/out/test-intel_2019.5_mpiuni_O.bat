...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_O_develop
...
ssh gaea10 /lustre/f2/dev/ncep/Mark.Potts//lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_O_develop/getres-int.sh
