Mon Sep 20 11:26:24 EDT 2021
#!/bin/sh -l
#SBATCH --account=nggps_emc
#SBATCH -o test-intel_2019.5_mpi_O.bat_%j.o
#SBATCH -e test-intel_2019.5_mpi_O.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_develop
...
ssh gaea10 /lustre/f2/dev/ncep/Mark.Potts//lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_develop/getres-int.sh
