Tue Sep 21 02:23:40 EDT 2021
#!/bin/sh -l
#SBATCH --account=nggps_emc
#SBATCH -o test-intel_2019.5_mpi_g.bat_%j.o
#SBATCH -e test-intel_2019.5_mpi_g.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_g_develop
...
ssh gaea14 /lustre/f2/dev/ncep/Mark.Potts//lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_g_develop/getres-int.sh
