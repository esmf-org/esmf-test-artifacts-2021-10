build time -- 2021-05-02 06:56:06
...
ESMF_APPSDIR=/p/work1/mpotts/intel_2019.4_mpt_O_develop/apps/appsO/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
...
ESMF_F90LINKPATHS=-L/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -L/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -L/app/unsupported/netcdf-fortran-parallel/4.4.2/intel/sgimpt/lib -L/app/unsupported/hdf5-mpi/1.10.5/intel/sgimpt/lib -L/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib 
ESMF_F90ESMFLINKPATHS=-L/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/netcdf-fortran-parallel/4.4.2/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/hdf5-mpi/1.10.5/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/p/work1/mpotts/intel_2019.4_mpt_O_develop/src/include  -I/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/include -I/p/work1/mpotts/intel_2019.4_mpt_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_06-2-g7cd9acb' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/p/work1/mpotts/intel_2019.4_mpt_O_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -L/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -L/app/unsupported/netcdf-fortran-parallel/4.4.2/intel/sgimpt/lib -L/app/unsupported/hdf5-mpi/1.10.5/intel/sgimpt/lib -L/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -L/p/app/intel/parallel_studio_xe_2019_update4/compilers_and_libraries_2019.4.243/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/netcdf-fortran-parallel/4.4.2/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/hdf5-mpi/1.10.5/intel/sgimpt/lib -Wl,-rpath,/app/unsupported/netcdf-c-parallel/4.3.3.1/intel/sgimpt/lib -Wl,-rpath,/p/app/intel/parallel_studio_xe_2019_update4/compilers_and_libraries_2019.4.243/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKLIBS= -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
ESMF_CXXESMFLINKLIBS=-lesmf  -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
...
ESMF_TRACE_LDPRELOAD=/p/work1/mpotts/intel_2019.4_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/p/work1/mpotts/intel_2019.4_mpt_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /p/work1/mpotts/intel_2019.4_mpt_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
