build time -- 2021-05-04 07:04:57
...
ESMF_APPSDIR=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/apps/appsg/Linux.intel.64.intelmpi.default
ESMF_LIBSDIR=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default
...
ESMF_F90COMPILEPATHS=-I/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/mod/modg/Linux.intel.64.intelmpi.default -I/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/src/include -I/app/COST/netcdf-c/4.3.3.1/intel/include -I/app/COST/netcdf-fortran/4.4.2/intel/include /app/COST/netcdf-c/4.3.3.1/intel//include /app/COST/hdf5/1.8.15/intel//include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_06-2-g7cd9acb' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop
...
ESMF_F90LINKPATHS=-L/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default -L/app/COST/netcdf-c/4.3.3.1/intel//lib -L/app/COST/netcdf-fortran/4.4.2/intel/lib -L/app/COST/netcdf-c/4.3.3.1/intel//lib -L/app/COST/hdf5/1.8.15/intel//lib 
ESMF_F90ESMFLINKPATHS=-L/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default -Wl,-rpath,/app/COST/netcdf-c/4.3.3.1/intel//lib -Wl,-rpath,/app/COST/netcdf-fortran/4.4.2/intel/lib -Wl,-rpath,/app/COST/netcdf-c/4.3.3.1/intel//lib -Wl,-rpath,/app/COST/hdf5/1.8.15/intel//lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default
ESMF_F90LINKLIBS= -cxxlib -lrt -ldl -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
ESMF_F90ESMFLINKLIBS=-lesmf  -cxxlib -lrt -ldl -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
...
ESMF_CXXCOMPILEPATHS= -I/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/src/include  -I/app/COST/netcdf-c/4.3.3.1/intel/include -I/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_06-2-g7cd9acb' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default -L/app/COST/netcdf-c/4.3.3.1/intel//lib -L/app/COST/netcdf-fortran/4.4.2/intel/lib -L/app/COST/netcdf-c/4.3.3.1/intel//lib -L/app/COST/hdf5/1.8.15/intel//lib -L/p/app/intel/parallel_studio_xe_2020_update2/compilers_and_libraries_2020.2.254/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default -Wl,-rpath,/app/COST/netcdf-c/4.3.3.1/intel//lib -Wl,-rpath,/app/COST/netcdf-fortran/4.4.2/intel/lib -Wl,-rpath,/app/COST/netcdf-c/4.3.3.1/intel//lib -Wl,-rpath,/app/COST/hdf5/1.8.15/intel//lib -Wl,-rpath,/p/app/intel/parallel_studio_xe_2020_update2/compilers_and_libraries_2020.2.254/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default
ESMF_CXXLINKLIBS= -ldl -lrt -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
ESMF_CXXESMFLINKLIBS=-lesmf  -ldl -lrt -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff -lnetcdf -lhdf5 -lhdf5_hl -lz
...
ESMF_TRACE_LDPRELOAD=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop/lib/libg/Linux.intel.64.intelmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/p/work1/mpotts/intel_2020.2_intelmpi_g_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /p/work1/mpotts/intel_2020.2_intelmpi_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
