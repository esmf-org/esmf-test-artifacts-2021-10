build time -- 2021-05-21 03:33:15.476411
...
ESMF_APPSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/apps/appsg/Linux.gfortran.64.intelmpi.default
ESMF_LIBSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default
...
ESMF_F90LINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default  -L/usr/local/other/gcc/8.3.0/lib64/../lib64/
ESMF_F90ESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default  -Wl,-rpath,/usr/local/other/gcc/8.3.0/lib64/../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/src/include   -I/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_08-26-gb4c535d3b3' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default  -L/usr/local/other/gcc/8.3.0/lib64/../lib64/
ESMF_CXXESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default  -Wl,-rpath,/usr/local/other/gcc/8.3.0/lib64/../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default
...
ESMF_TRACE_LDPRELOAD=/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop/lib/libg/Linux.gfortran.64.intelmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /gpfsm/dnb04/projects/p98/mpotts/esmf/gfortran_8.3.0_intelmpi_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
