build time -- 2021-05-21 03:35:16.590082
...
ESMF_APPSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/apps/appsg/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default
...
ESMF_F90LINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib 
ESMF_F90ESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/src/include  -I/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/include -I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/src/prologue/yaml-cpp/include
...
ESMF_CXXLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/gpfsm/dulocal/sles12/intel/2020/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -Wl,-rpath,/gpfsm/dulocal/sles12/intel/2020/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default
ESMF_CXXLINKLIBS= -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lnetcdff
ESMF_CXXESMFLINKLIBS=-lesmf  -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lnetcdff
...
ESMF_TRACE_LDPRELOAD=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop/lib/libg/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
