build time -- 2021-05-21 06:04:29.433115
...
ESMF_APPSDIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/apps/appsO/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib 
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/src/include  -I/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/include -I/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_08-26-gb4c535d3b3' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -Wl,-rpath,/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKLIBS= -lsz -lz -limf -lm -ldl -lrt -ldl -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
ESMF_CXXESMFLINKLIBS=-lesmf  -lsz -lz -limf -lm -ldl -lrt -ldl -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdf -lnetcdff -lnetcdf -lnetcdf
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop/lib/libO/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_develop

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/mpotts/intel_18.0.5_mpt_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
