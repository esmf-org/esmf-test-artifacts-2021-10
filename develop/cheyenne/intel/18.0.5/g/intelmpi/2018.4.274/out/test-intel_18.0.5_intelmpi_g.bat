...
ssh cheyenne6 /glade/scratch/mpotts//glade/scratch/mpotts/intel_18.0.5_intelmpi_g_develop/getres-int.sh
...
ssh cheyenne6 /glade/scratch/mpotts/intel_18.0.5_intelmpi_g_develop/runpython.sh 2>&1 | tee python_build.log
python3 setup.py test 2>&1 | tee python_test.log
python3 setup.py test_examples 2>&1 | tee python_examples.log
python3 setup.py test_regrid_from_file 2>&1 | tee python_regrid.log
ssh cheyenne6 /glade/scratch/mpotts/intel_18.0.5_intelmpi_g_develop/getres-test.sh
