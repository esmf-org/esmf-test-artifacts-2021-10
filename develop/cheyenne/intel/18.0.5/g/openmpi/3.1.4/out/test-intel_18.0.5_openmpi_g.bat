...
ssh cheyenne6 /glade/scratch/mpotts//glade/scratch/mpotts/intel_18.0.5_openmpi_g_develop/getres-int.sh
...
ssh cheyenne6 /glade/scratch/mpotts/intel_18.0.5_openmpi_g_develop/runpython.sh 2>&1 | tee python_build.log
