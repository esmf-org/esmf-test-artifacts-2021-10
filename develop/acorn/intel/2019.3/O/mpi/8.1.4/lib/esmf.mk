build time -- 2021-06-18 16:51:19
...
ESMF_F90COMPILEPATHS=-I/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/mod/modO/Linux.intel.64.mpi.default -I/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/src/include 
...
ESMF_F90LINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default  
ESMF_F90ESMFLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default 
...
ESMF_CXXCOMPILEPATHS= -I/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/src/include   -I/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-fPIC -DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_11-1-g4c3a005616' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpi -DESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_11-1-g4c3a005616' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpi -DESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=-fPIC -lnetcdff -lnetcdff  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default  -L/pe/intel/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/lib/libO/Linux.intel.64.mpi.default  -Wl,-rpath,/pe/intel/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
...
ESMF_CXXLINKLIBS= -lmpi -lfmpich -lsci_intel_mpi_mp -lsci_intel_mp -ldl -ldsmml -limf -lm -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi -lfmpich -lsci_intel_mpi_mp -lsci_intel_mp -ldl -ldsmml -limf -lm -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl -lnetcdff
...
# ESMF_NETCDF:            /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_develop/nc-config
