...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts//lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_develop/getres-int.sh
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_develop/runpython.sh 2>&1 | tee python_build.log
